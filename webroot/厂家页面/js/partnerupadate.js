function Partnerupadate() {
    ...
    /*allrecord:全部的记录条数
     ...
     curpage:当前的页码
     groupsize:页码组的大小*/
    var allpage=1,curpage=1,groupsize=29,allrecord,goodsid;
    ...
    $("#Partner_xx").click(function () {
        ...
        $.ajax(url, {
            ...
            success: function (data) {
                var json=data;
                allrecord=json.data.length;
                allpage=allrecord/groupsize+1;
                var cell=$("#xx_list .cell");
                for(var i=(curpage-1)*groupsize;i<cell.length/6+(curpage-1)*groupsize&&i<json.data.length;i++){
